...
def make_pdf(path: Path, *, text='Invoice total 42', table=False):
    if table:
        ...
        cells = [(40,235,'Item'),(180,235,'Total'),(40,195,'Invoice A'),(180,195,'42'),(40,155,'Invoice B'),(180,155,'75')]
...
def make_image(path: Path, text='INVOICE REF 7316\nTotal amount 4200'):
    ...
    draw=ImageDraw.Draw(image);font=ImageFont.load_default(size=38)
    draw.multiline_text((30,35),text,font=font,fill='black',spacing=20)
    image.save(path);image.close();return path
