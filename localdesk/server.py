        ...
        def do_GET(self):
            ...
            if request.path.startswith("/api/"):
                ...
                try:
                    ...
                    return self._json(
                        500, {"error": "The operation failed. Check the app input and try again."}
                    )
            ...
            if (
                ...
                or not path.is_file()
                or path.suffix not in {".html", ".css", ".js", ".svg", ".png", ".gif", ".ico"}
            ):
            ...
            return self._send(
                200, raw, mimetypes.guess_type(str(path))[0] or "application/octet-stream"
            )
