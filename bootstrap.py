...
def main() -> int:
    ...
    parser.add_argument(
        "--desktop", action="store_true", help="Also install mouse and keyboard automation tools."
    )
    parser.add_argument(
        "--offline", action="store_true", help="Install only from --wheelhouse, without an index."
    )
    parser.add_argument(
        "--wheelhouse", type=Path, help="A folder of packages for this OS and Python version."
    )
